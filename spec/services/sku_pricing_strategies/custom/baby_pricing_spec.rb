...
RSpec.describe SkuPricingStrategies::Custom::BabyPricing, type: :service do
  ...
  context 'valid' do
    ...
    describe "should call by time strategy" do
      ...
      it do
        allow(SkuPricingStrategies::ByTime::BabyPricing).to receive(:new) { by_time_adult_double }
