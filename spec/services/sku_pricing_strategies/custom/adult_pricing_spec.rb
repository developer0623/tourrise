...
RSpec.describe SkuPricingStrategies::Custom::AdultPricing, type: :service do
  ...
  context 'valid' do
    ...
    describe "should call by time strategy" do
      ...
      it do
        allow(SkuPricingStrategies::ByTime::AdultPricing).to receive(:new) { by_time_adult_double }
