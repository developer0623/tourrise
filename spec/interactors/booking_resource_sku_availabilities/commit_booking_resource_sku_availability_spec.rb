...
RSpec.describe BookingResourceSkuAvailabilities::CommitBookingResourceSkuAvailability, type: :interactor do
  describe '.call' do
  ...
  describe '.rollback' do
    ...
    it 'clears the booked by and booked at columns' do
