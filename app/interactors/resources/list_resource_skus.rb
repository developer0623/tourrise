...
module Resources
  class ListResourceSkus
    ...
    def call
      context.resource_skus = ResourceSku.with_translations(I18n.locale).where(resource_id: context.resource_id)
    ...
    def sort_by_name
      context.resource_skus = context.resource_skus.order("resource_sku_translations.name": context.sort_order)
    end
