...
ActiveRecord::Schema.define(version: 2021_03_12_100535) do
  ...
  create_table "booking_attribute_values", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["booking_resource_sku_id", "handle"], name: "not_d_idx_b_attr_vals_on_b_res_sku_id_hndl"
    t.index ["booking_resource_sku_id"], name: "index_booking_attribute_values_on_booking_resource_sku_id"
    t.index ["booking_resource_sku_id"], name: "not_d_indx_booking_attribute_values_on_b_rsc_sku_id"
    t.index ["deleted_at"], name: "index_booking_attribute_values_on_deleted_at"
  end
  ...
  create_table "booking_credits", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "booking_id"
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.datetime "deleted_at"
    t.index ["booking_id"], name: "index_booking_credits_on_booking_id"
    t.index ["cost_center_id"], name: "index_booking_credits_on_cost_center_id"
    t.index ["deleted_at"], name: "index_booking_credits_on_deleted_at"
    t.index ["financial_account_id"], name: "index_booking_credits_on_financial_account_id"
  end
  ...
  create_table "booking_invoices", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.text "booking_resource_skus_snapshot", size: :medium
    t.text "booking_resource_sku_groups_snapshot", size: :medium
    t.string "scrambled_id"
    t.text "booking_credits_snapshot"
    t.text "description"
    t.string "type", default: "BookingInvoice"
  ...
  create_table "booking_resource_sku_availabilities", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["booking_resource_sku_id"], name: "not_d_idx_b_rsc_sku_avlbilts_on_b_rsc_sku_id"
  end
  ...
  create_table "booking_resource_sku_customers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["booking_resource_sku_id"], name: "not_d_idx_sku_cus_on_sku_id"
    t.index ["customer_id"], name: "idx_sku_customers_on_participant_id"
    t.index ["deleted_at"], name: "index_booking_resource_sku_customers_on_deleted_at"
  end
  ...
  create_table "booking_resource_sku_flights", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["booking_resource_sku_id"], name: "not_d_index_b_res_sku_flights_on_b_rsc_sku_id"
    t.index ["deleted_at"], name: "index_booking_resource_sku_flights_on_deleted_at"
  ...
  create_table "booking_resource_sku_groups", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["deleted_at"], name: "index_booking_resource_sku_groups_on_deleted_at"
  ...
  create_table "booking_resource_sku_groups_skus", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["booking_resource_sku_group_id"], name: "not_d_idx_bkng_rsrc_sku_grps_skus_on_bkng_rsrc_sku_grps_id"
    t.index ["booking_resource_sku_id"], name: "idx_bkng_rsrc_sku_grps_skus_on_bkng_rsrc_sku_id"
    t.index ["booking_resource_sku_id"], name: "not_d_idx_bkng_rsrc_sku_grps_skus_on_bkng_rsrc_sku_id"
  end
  ...
  create_table "booking_resource_sku_participants", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["booking_resource_sku_id"], name: "not_d_idx_sku_ptcts_on_sku_id"
  ...
  create_table "booking_resource_skus", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["deleted_at"], name: "index_booking_resource_skus_on_deleted_at"
  ...
  create_table "cancellation_reasons", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name", null: false
    t.text "description"
    t.datetime "deleted_at"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["deleted_at"], name: "index_cancellation_reasons_on_deleted_at"
  end

  create_table "cancellations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "user_id"
    t.string "cancellable_type"
    t.bigint "cancellable_id"
    t.bigint "cancellation_reason_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["cancellable_type", "cancellable_id"], name: "index_cancellations_on_cancellable_type_and_cancellable_id"
  ...
  create_table "consecutive_days_ranges", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "price_cents", default: 0, null: false
    t.string "price_currency", default: "EUR", null: false
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "resource_sku_pricing_id", null: false
    t.index ["resource_sku_pricing_id"], name: "index_consecutive_days_ranges_on_resource_sku_pricing_id"
  end
  ...
  create_table "document_references", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.integer "price_cents", default: 0, null: false
    t.string "price_currency", default: "EUR", null: false
    t.index ["document_type", "document_id"], name: "index_document_references_on_document_type_and_document_id"
    t.index ["item_type", "item_id"], name: "index_document_references_on_item_type_and_item_id"
  end
  ...
  create_table "products", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["current_season_id"], name: "index_products_on_current_season_id"
  ...
  add_foreign_key "consecutive_days_ranges", "resource_sku_pricings"
